...
import com.k2.dev.model.meta.component.MetaK2Service;
import com.k2.dev.service.K2ServiceService;

@Controller("K2ServiceController")
public class K2ServiceController extends AbstractStatelessEntityController<K2Service> {
    ...
    @Autowired
    private K2ServiceService service;
    
    @Autowired
    public K2ServiceController(OutputFormatterContextFactory formatterContextFactory, ApplicationContext snippetContext) {
    	super(formatterContextFactory, snippetContext);
    }
    
    @SuppressWarnings("rawtypes")
    @Override
    protected List<MetaField> getMetaFields() { return MetaK2Service.Fields.getFields(); }
    
    @Override
    @SuppressWarnings("rawtypes")
    protected MetaField getMetaField(String parmName) { return  MetaK2Service.Fields.getMetaField(parmName); }
    
    @Override
    @SuppressWarnings("rawtypes")
    protected MetaList getMetaList(String listAlias) { return  MetaK2Service.Lists.getMetaList(listAlias); }
    
    @SuppressWarnings("rawtypes")
    @Override
    protected List<MetaList> getMetaLists() { return MetaK2Service.Lists.getLists(); }
    
    @SuppressWarnings("rawtypes")
    @Override
    protected MetaMethod getMetaMethod(String methodAlias) { return MetaK2Service.Methods.getMetaMethod(methodAlias); }
    
    @SuppressWarnings("rawtypes")
    @Override
    protected List<MetaMethod> getMetaMethods() { return MetaK2Service.Methods.getMethods(); }
    
    @Override
    protected MetaModelEntity getMetaEntity() { return MetaModel.Entities.K2SERVICE; }
    
    
    @RequestMapping(value="/entities/k2Service", method=RequestMethod.GET)
    public void getEntityList(
    	  ...
    	  try {
    		  ...
    		  presentEntityList(service.listAll(), MetaK2Service.defaultFieldSet, messages, request, response);
    ...
    @RequestMapping(value="/entities/k2Service", method=RequestMethod.POST)
    ...
    @RequestMapping(value="/entities/k2Service/{id}", method=RequestMethod.GET)
    public void getEntity(
    	  ...
    	  outputAssembly.setContext(ctxManager);
    	  Conversation conversation = appContext.getBean(RequestConversation.class);
    	  currentConversation.set(conversation.begin("get-k2Service").readOnly());
    	  
    	  try {
    		  
    		  List<Message> messages = getMessages(model);
    		  
    		  K2Service entity = service.fetch(id);
    ...
    @RequestMapping(value="/entities/k2Service/{id}", method=RequestMethod.POST)
    	  ...
    	  try {
    	  	  ...
    	  	  if (k2Action != null) {
    	  		  ...
    	  		  if (k2Action.startsWith("method:")) {
    	  			  ...
    	  			  MetaMethod<K2Service> metaMethod = MetaK2Service.Methods.getMetaMethod(methodAlias);
    	  			  if (metaMethod.methodParameters.size() == 0) {
    	  				  MethodHandler<K2Service> methodHandler = metaMethod.getHandler(entity);
    ...
    @RequestMapping(value="/entities/k2Service/new", method=RequestMethod.GET)
    public void getNewEntity(
    	  ...
    	  outputAssembly.setContext(ctxManager);
    	  Conversation conversation = appContext.getBean(RequestConversation.class);
    	  currentConversation.set(conversation.begin("new-k2Service").readOnly());
    	  
    	  try {
    		  
    		  List<Message> messages = getMessages(model);
    		  
    		  K2Service entity = service.listAll().newBO();
    ...
    @RequestMapping(value="/entities/k2Service/new", method=RequestMethod.POST)
    public void postNewEntity(
    	  ...
    	  currentConversation.set(conversation.begin());
      	  ...
      	  try {
      		  ...
      		  K2Service entity = K2ServiceBO.NULL;
      		  if (newId != null) {
    ...
    @RequestMapping(value="/entities/k2Service/{id}/list/{listAlias}", method=RequestMethod.GET)
    public void getListFromEntity(
    	  ...
    	  try {
    		  ...
    		  MetaList metaList = MetaK2Service.Lists.getMetaList(listAlias);
    ...
    @RequestMapping(value="/entities/k2Service/{id}/list/{listAlias}", method=RequestMethod.POST)
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    @RequestMapping(value="/entities/k2Service/{id}/list/{listAlias}/new", method=RequestMethod.GET)
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    @RequestMapping(value="/entities/k2Service/{id}/list/{listAlias}/new", method=RequestMethod.POST)
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    @RequestMapping(value="/entities/k2Service/{id}/list/{listAlias}/{subAlias}/new", method=RequestMethod.GET)
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    @RequestMapping(value="/entities/k2Service/{id}/list/{listAlias}/{subAlias}/new", method=RequestMethod.POST)
    ...
    @SuppressWarnings({ "rawtypes" })
    @RequestMapping(value="/entities/k2Service/{id}/method/{methodAlias}", method=RequestMethod.GET)
    public void getMethodParameters(
    	  ...
    	  try {
    		  ...
    		  MetaMethod metaMethod = MetaK2Service.Methods.getMetaMethod(methodAlias);
    ...
    @SuppressWarnings({ "rawtypes" })
    @RequestMapping(value="/entities/k2Service/{id}/method/{methodAlias}", method=RequestMethod.POST)
