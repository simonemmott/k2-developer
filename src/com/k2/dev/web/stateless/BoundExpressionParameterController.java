...
import com.k2.dev.model.meta.component.MetaBoundExpressionParameter;
import com.k2.dev.service.BoundExpressionParameterService;

@Controller("BoundExpressionParameterController")
public class BoundExpressionParameterController extends AbstractStatelessEntityController<BoundExpressionParameter> {
    ...
    @Autowired
    private BoundExpressionParameterService service;
    
    @Autowired
    public BoundExpressionParameterController(OutputFormatterContextFactory formatterContextFactory, ApplicationContext snippetContext) {
    	super(formatterContextFactory, snippetContext);
    }
    
    @SuppressWarnings("rawtypes")
    @Override
    protected List<MetaField> getMetaFields() { return MetaBoundExpressionParameter.Fields.getFields(); }
    
    @Override
    @SuppressWarnings("rawtypes")
    protected MetaField getMetaField(String parmName) { return  MetaBoundExpressionParameter.Fields.getMetaField(parmName); }
    
    @Override
    @SuppressWarnings("rawtypes")
    protected MetaList getMetaList(String listAlias) { return  MetaBoundExpressionParameter.Lists.getMetaList(listAlias); }
    
    @SuppressWarnings("rawtypes")
    @Override
    protected List<MetaList> getMetaLists() { return MetaBoundExpressionParameter.Lists.getLists(); }
    
    @SuppressWarnings("rawtypes")
    @Override
    protected MetaMethod getMetaMethod(String methodAlias) { return MetaBoundExpressionParameter.Methods.getMetaMethod(methodAlias); }
    
    @SuppressWarnings("rawtypes")
    @Override
    protected List<MetaMethod> getMetaMethods() { return MetaBoundExpressionParameter.Methods.getMethods(); }
    
    @Override
    protected MetaModelEntity getMetaEntity() { return MetaModel.Entities.BOUND_EXPRESSION_PARAMETER; }
    
    
    @RequestMapping(value="/entities/boundExpressionParameter", method=RequestMethod.GET)
    public void getEntityList(
    	  ...
    	  try {
    		  ...
    		  presentEntityList(service.listAll(), MetaBoundExpressionParameter.defaultFieldSet, messages, request, response);
    ...
    @RequestMapping(value="/entities/boundExpressionParameter", method=RequestMethod.POST)
    ...
    @RequestMapping(value="/entities/boundExpressionParameter/{id}", method=RequestMethod.GET)
    public void getEntity(
    	  ...
    	  outputAssembly.setContext(ctxManager);
    	  Conversation conversation = appContext.getBean(RequestConversation.class);
    	  currentConversation.set(conversation.begin("get-boundExpressionParameter").readOnly());
    	  
    	  try {
    		  
    		  List<Message> messages = getMessages(model);
    		  
    		  BoundExpressionParameter entity = service.fetch(id);
    ...
    @RequestMapping(value="/entities/boundExpressionParameter/{id}", method=RequestMethod.POST)
    	  ...
    	  try {
    	  	  ...
    	  	  if (k2Action != null) {
    	  		  ...
    	  		  if (k2Action.startsWith("method:")) {
    	  			  ...
    	  			  MetaMethod<BoundExpressionParameter> metaMethod = MetaBoundExpressionParameter.Methods.getMetaMethod(methodAlias);
    	  			  if (metaMethod.methodParameters.size() == 0) {
    	  				  MethodHandler<BoundExpressionParameter> methodHandler = metaMethod.getHandler(entity);
    ...
    @RequestMapping(value="/entities/boundExpressionParameter/new", method=RequestMethod.GET)
    public void getNewEntity(
    	  ...
    	  outputAssembly.setContext(ctxManager);
    	  Conversation conversation = appContext.getBean(RequestConversation.class);
    	  currentConversation.set(conversation.begin("new-boundExpressionParameter").readOnly());
    	  
    	  try {
    		  
    		  List<Message> messages = getMessages(model);
    		  
    		  BoundExpressionParameter entity = service.listAll().newBO();
    ...
    @RequestMapping(value="/entities/boundExpressionParameter/new", method=RequestMethod.POST)
    public void postNewEntity(
    	  ...
    	  currentConversation.set(conversation.begin());
      	  ...
      	  try {
      		  ...
      		  BoundExpressionParameter entity = BoundExpressionParameterBO.NULL;
      		  if (newId != null) {
    ...
    @RequestMapping(value="/entities/boundExpressionParameter/{id}/list/{listAlias}", method=RequestMethod.GET)
    public void getListFromEntity(
    	  ...
    	  try {
    		  ...
    		  MetaList metaList = MetaBoundExpressionParameter.Lists.getMetaList(listAlias);
    ...
    @RequestMapping(value="/entities/boundExpressionParameter/{id}/list/{listAlias}", method=RequestMethod.POST)
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    @RequestMapping(value="/entities/boundExpressionParameter/{id}/list/{listAlias}/new", method=RequestMethod.GET)
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    @RequestMapping(value="/entities/boundExpressionParameter/{id}/list/{listAlias}/new", method=RequestMethod.POST)
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    @RequestMapping(value="/entities/boundExpressionParameter/{id}/list/{listAlias}/{subAlias}/new", method=RequestMethod.GET)
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    @RequestMapping(value="/entities/boundExpressionParameter/{id}/list/{listAlias}/{subAlias}/new", method=RequestMethod.POST)
    ...
    @SuppressWarnings({ "rawtypes" })
    @RequestMapping(value="/entities/boundExpressionParameter/{id}/method/{methodAlias}", method=RequestMethod.GET)
    public void getMethodParameters(
    	  ...
    	  try {
    		  ...
    		  MetaMethod metaMethod = MetaBoundExpressionParameter.Methods.getMetaMethod(methodAlias);
    ...
    @SuppressWarnings({ "rawtypes" })
    @RequestMapping(value="/entities/boundExpressionParameter/{id}/method/{methodAlias}", method=RequestMethod.POST)
