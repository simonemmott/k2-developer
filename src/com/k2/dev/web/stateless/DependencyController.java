...
import com.k2.dev.model.meta.component.MetaDependency;
import com.k2.dev.service.DependencyService;

@Controller("DependencyController")
public class DependencyController extends AbstractStatelessEntityController<Dependency> {
    ...
    @Autowired
    public DependencyController(OutputFormatterContextFactory formatterContextFactory, ApplicationContext snippetContext) {
    	super(formatterContextFactory, snippetContext);
    }
    
    @SuppressWarnings("rawtypes")
    @Override
    protected List<MetaField> getMetaFields() { return MetaDependency.Fields.getFields(); }
    
    @Override
    @SuppressWarnings("rawtypes")
    protected MetaField getMetaField(String parmName) { return  MetaDependency.Fields.getMetaField(parmName); }
    
    @Override
    @SuppressWarnings("rawtypes")
    protected MetaList getMetaList(String listAlias) { return  MetaDependency.Lists.getMetaList(listAlias); }
    
    @SuppressWarnings("rawtypes")
    @Override
    protected List<MetaList> getMetaLists() { return MetaDependency.Lists.getLists(); }
    
    @SuppressWarnings("rawtypes")
    @Override
    protected MetaMethod getMetaMethod(String methodAlias) { return MetaDependency.Methods.getMetaMethod(methodAlias); }
    
    @SuppressWarnings("rawtypes")
    @Override
    protected List<MetaMethod> getMetaMethods() { return MetaDependency.Methods.getMethods(); }
    
    @Override
    protected MetaModelEntity getMetaEntity() { return MetaModel.Entities.DEPENDENCY; }
    
    
    @RequestMapping(value="/entities/dependency", method=RequestMethod.GET)
    public void getEntityList(
    	  ...
    	  try {
    		  ...
    		  presentEntityList(service.listAll(), MetaDependency.defaultFieldSet, messages, request, response);
    ...
    @RequestMapping(value="/entities/dependency", method=RequestMethod.POST)
    ...
    @RequestMapping(value="/entities/dependency/{id}", method=RequestMethod.GET)
    public void getEntity(
    	  ...
    	  outputAssembly.setContext(ctxManager);
    	  Conversation conversation = appContext.getBean(RequestConversation.class);
    	  currentConversation.set(conversation.begin("get-dependency").readOnly());
    	  
    	  try {
    		  
    		  List<Message> messages = getMessages(model);
    		  
    		  Dependency entity = service.fetch(id);
    ...
    @RequestMapping(value="/entities/dependency/{id}", method=RequestMethod.POST)
    	  ...
    	  try {
    	  	  ...
    	  	  if (k2Action != null) {
    	  		  ...
    	  		  if (k2Action.startsWith("method:")) {
    	  			  ...
    	  			  MetaMethod<Dependency> metaMethod = MetaDependency.Methods.getMetaMethod(methodAlias);
    	  			  if (metaMethod.methodParameters.size() == 0) {
    	  				  MethodHandler<Dependency> methodHandler = metaMethod.getHandler(entity);
    ...
    @RequestMapping(value="/entities/dependency/new", method=RequestMethod.GET)
    public void getNewEntity(
    	  ...
    	  outputAssembly.setContext(ctxManager);
    	  Conversation conversation = appContext.getBean(RequestConversation.class);
    	  currentConversation.set(conversation.begin("new-dependency").readOnly());
    	  
    	  try {
    		  
    		  List<Message> messages = getMessages(model);
    		  
    		  Dependency entity = service.listAll().newBO();
    ...
    @RequestMapping(value="/entities/dependency/new", method=RequestMethod.POST)
    public void postNewEntity(
    	  ...
    	  currentConversation.set(conversation.begin());
      	  ...
      	  try {
      		  ...
      		  Dependency entity = DependencyBO.NULL;
      		  if (newId != null) {
    ...
    @RequestMapping(value="/entities/dependency/{id}/list/{listAlias}", method=RequestMethod.GET)
    public void getListFromEntity(
    	  ...
    	  try {
    		  ...
    		  MetaList metaList = MetaDependency.Lists.getMetaList(listAlias);
    ...
    @RequestMapping(value="/entities/dependency/{id}/list/{listAlias}", method=RequestMethod.POST)
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    @RequestMapping(value="/entities/dependency/{id}/list/{listAlias}/new", method=RequestMethod.GET)
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    @RequestMapping(value="/entities/dependency/{id}/list/{listAlias}/new", method=RequestMethod.POST)
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    @RequestMapping(value="/entities/dependency/{id}/list/{listAlias}/{subAlias}/new", method=RequestMethod.GET)
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    @RequestMapping(value="/entities/dependency/{id}/list/{listAlias}/{subAlias}/new", method=RequestMethod.POST)
    ...
    @SuppressWarnings({ "rawtypes" })
    @RequestMapping(value="/entities/dependency/{id}/method/{methodAlias}", method=RequestMethod.GET)
    public void getMethodParameters(
    	  ...
    	  try {
    		  ...
    		  MetaMethod metaMethod = MetaDependency.Methods.getMetaMethod(methodAlias);
    ...
    @SuppressWarnings({ "rawtypes" })
    @RequestMapping(value="/entities/dependency/{id}/method/{methodAlias}", method=RequestMethod.POST)
