...
import com.k2.dev.model.meta.component.MetaK2Method;
import com.k2.dev.service.K2MethodService;

@Controller("K2MethodController")
public class K2MethodController extends AbstractStatelessEntityController<K2Method> {
    ...
    @Autowired
    private K2MethodService service;
    
    @Autowired
    public K2MethodController(OutputFormatterContextFactory formatterContextFactory, ApplicationContext snippetContext) {
    	super(formatterContextFactory, snippetContext);
    }
    
    @SuppressWarnings("rawtypes")
    @Override
    protected List<MetaField> getMetaFields() { return MetaK2Method.Fields.getFields(); }
    
    @Override
    @SuppressWarnings("rawtypes")
    protected MetaField getMetaField(String parmName) { return  MetaK2Method.Fields.getMetaField(parmName); }
    
    @Override
    @SuppressWarnings("rawtypes")
    protected MetaList getMetaList(String listAlias) { return  MetaK2Method.Lists.getMetaList(listAlias); }
    
    @SuppressWarnings("rawtypes")
    @Override
    protected List<MetaList> getMetaLists() { return MetaK2Method.Lists.getLists(); }
    
    @SuppressWarnings("rawtypes")
    @Override
    protected MetaMethod getMetaMethod(String methodAlias) { return MetaK2Method.Methods.getMetaMethod(methodAlias); }
    
    @SuppressWarnings("rawtypes")
    @Override
    protected List<MetaMethod> getMetaMethods() { return MetaK2Method.Methods.getMethods(); }
    
    @Override
    protected MetaModelEntity getMetaEntity() { return MetaModel.Entities.K2METHOD; }
    
    
    @RequestMapping(value="/entities/k2Method", method=RequestMethod.GET)
    public void getEntityList(
    	  ...
    	  try {
    		  ...
    		  presentEntityList(service.listAll(), MetaK2Method.defaultFieldSet, messages, request, response);
    ...
    @RequestMapping(value="/entities/k2Method", method=RequestMethod.POST)
    ...
    @RequestMapping(value="/entities/k2Method/{id}", method=RequestMethod.GET)
    public void getEntity(
    	  ...
    	  outputAssembly.setContext(ctxManager);
    	  Conversation conversation = appContext.getBean(RequestConversation.class);
    	  currentConversation.set(conversation.begin("get-k2Method").readOnly());
    	  
    	  try {
    		  
    		  List<Message> messages = getMessages(model);
    		  
    		  K2Method entity = service.fetch(id);
    ...
    @RequestMapping(value="/entities/k2Method/{id}", method=RequestMethod.POST)
    	  ...
    	  try {
    	  	  ...
    	  	  if (k2Action != null) {
    	  		  ...
    	  		  if (k2Action.startsWith("method:")) {
    	  			  ...
    	  			  MetaMethod<K2Method> metaMethod = MetaK2Method.Methods.getMetaMethod(methodAlias);
    	  			  if (metaMethod.methodParameters.size() == 0) {
    	  				  MethodHandler<K2Method> methodHandler = metaMethod.getHandler(entity);
    ...
    @RequestMapping(value="/entities/k2Method/new", method=RequestMethod.GET)
    public void getNewEntity(
    	  ...
    	  outputAssembly.setContext(ctxManager);
    	  Conversation conversation = appContext.getBean(RequestConversation.class);
    	  currentConversation.set(conversation.begin("new-k2Method").readOnly());
    	  
    	  try {
    		  
    		  List<Message> messages = getMessages(model);
    		  
    		  K2Method entity = service.listAll().newBO();
    ...
    @RequestMapping(value="/entities/k2Method/new", method=RequestMethod.POST)
    public void postNewEntity(
    	  ...
    	  currentConversation.set(conversation.begin());
      	  ...
      	  try {
      		  ...
      		  K2Method entity = K2MethodBO.NULL;
      		  if (newId != null) {
    ...
    @RequestMapping(value="/entities/k2Method/{id}/list/{listAlias}", method=RequestMethod.GET)
    public void getListFromEntity(
    	  ...
    	  try {
    		  ...
    		  MetaList metaList = MetaK2Method.Lists.getMetaList(listAlias);
    ...
    @RequestMapping(value="/entities/k2Method/{id}/list/{listAlias}", method=RequestMethod.POST)
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    @RequestMapping(value="/entities/k2Method/{id}/list/{listAlias}/new", method=RequestMethod.GET)
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    @RequestMapping(value="/entities/k2Method/{id}/list/{listAlias}/new", method=RequestMethod.POST)
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    @RequestMapping(value="/entities/k2Method/{id}/list/{listAlias}/{subAlias}/new", method=RequestMethod.GET)
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    @RequestMapping(value="/entities/k2Method/{id}/list/{listAlias}/{subAlias}/new", method=RequestMethod.POST)
    ...
    @SuppressWarnings({ "rawtypes" })
    @RequestMapping(value="/entities/k2Method/{id}/method/{methodAlias}", method=RequestMethod.GET)
    public void getMethodParameters(
    	  ...
    	  try {
    		  ...
    		  MetaMethod metaMethod = MetaK2Method.Methods.getMetaMethod(methodAlias);
    ...
    @SuppressWarnings({ "rawtypes" })
    @RequestMapping(value="/entities/k2Method/{id}/method/{methodAlias}", method=RequestMethod.POST)
