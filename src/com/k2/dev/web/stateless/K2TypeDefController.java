...
import com.k2.dev.model.meta.component.MetaK2TypeDef;
import com.k2.dev.service.K2TypeDefService;

@Controller("K2TypeDefController")
public class K2TypeDefController extends AbstractStatelessEntityController<K2TypeDef> {
    ...
    @Autowired
    private K2TypeDefService service;
    
    @Autowired
    public K2TypeDefController(OutputFormatterContextFactory formatterContextFactory, ApplicationContext snippetContext) {
    	super(formatterContextFactory, snippetContext);
    }
    
    @SuppressWarnings("rawtypes")
    @Override
    protected List<MetaField> getMetaFields() { return MetaK2TypeDef.Fields.getFields(); }
    
    @Override
    @SuppressWarnings("rawtypes")
    protected MetaField getMetaField(String parmName) { return  MetaK2TypeDef.Fields.getMetaField(parmName); }
    
    @Override
    @SuppressWarnings("rawtypes")
    protected MetaList getMetaList(String listAlias) { return  MetaK2TypeDef.Lists.getMetaList(listAlias); }
    
    @SuppressWarnings("rawtypes")
    @Override
    protected List<MetaList> getMetaLists() { return MetaK2TypeDef.Lists.getLists(); }
    
    @SuppressWarnings("rawtypes")
    @Override
    protected MetaMethod getMetaMethod(String methodAlias) { return MetaK2TypeDef.Methods.getMetaMethod(methodAlias); }
    ...
    public void getEntityList(
    	  ...
    	  try {
    		  ...
    		  presentEntityList(service.listAll(), MetaK2TypeDef.defaultFieldSet, messages, request, response);
    ...
    @RequestMapping(value="/entities/k2TypeDef", method=RequestMethod.POST)
    ...
    @RequestMapping(value="/entities/k2TypeDef/{id}", method=RequestMethod.GET)
    public void getEntity(
    	  ...
    	  outputAssembly.setContext(ctxManager);
    	  Conversation conversation = appContext.getBean(RequestConversation.class);
    	  currentConversation.set(conversation.begin("get-k2TypeDef").readOnly());
    	  
    	  try {
    		  
    		  List<Message> messages = getMessages(model);
    		  
    		  K2TypeDef entity = service.fetch(id);
    ...
    @RequestMapping(value="/entities/k2TypeDef/{id}", method=RequestMethod.POST)
    	  ...
    	  try {
    	  	  ...
    	  	  if (k2Action != null) {
    	  		  ...
    	  		  if (k2Action.startsWith("method:")) {
    	  			  ...
    	  			  MetaMethod<K2TypeDef> metaMethod = MetaK2TypeDef.Methods.getMetaMethod(methodAlias);
    	  			  if (metaMethod.methodParameters.size() == 0) {
    	  				  MethodHandler<K2TypeDef> methodHandler = metaMethod.getHandler(entity);
    ...
    @RequestMapping(value="/entities/k2TypeDef/new", method=RequestMethod.GET)
    public void getNewEntity(
    	  ...
    	  outputAssembly.setContext(ctxManager);
    	  Conversation conversation = appContext.getBean(RequestConversation.class);
    	  currentConversation.set(conversation.begin("new-k2TypeDef").readOnly());
    	  
    	  try {
    		  
    		  List<Message> messages = getMessages(model);
    		  
    		  K2TypeDef entity = service.listAll().newBO();
    ...
    @RequestMapping(value="/entities/k2TypeDef/new", method=RequestMethod.POST)
    public void postNewEntity(
    	  ...
    	  currentConversation.set(conversation.begin());
      	  ...
      	  try {
      		  ...
      		  K2TypeDef entity = service.newBO(newId);
    ...
    @RequestMapping(value="/entities/k2TypeDef/{id}/list/{listAlias}", method=RequestMethod.GET)
    public void getListFromEntity(
    	  ...
    	  try {
    		  ...
    		  MetaList metaList = MetaK2TypeDef.Lists.getMetaList(listAlias);
    ...
    @RequestMapping(value="/entities/k2TypeDef/{id}/list/{listAlias}", method=RequestMethod.POST)
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    @RequestMapping(value="/entities/k2TypeDef/{id}/list/{listAlias}/new", method=RequestMethod.GET)
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    @RequestMapping(value="/entities/k2TypeDef/{id}/list/{listAlias}/new", method=RequestMethod.POST)
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    @RequestMapping(value="/entities/k2TypeDef/{id}/list/{listAlias}/{subAlias}/new", method=RequestMethod.GET)
    ...
    @SuppressWarnings({ "rawtypes", "unchecked" })
    @RequestMapping(value="/entities/k2TypeDef/{id}/list/{listAlias}/{subAlias}/new", method=RequestMethod.POST)
    ...
    @SuppressWarnings({ "rawtypes" })
    @RequestMapping(value="/entities/k2TypeDef/{id}/method/{methodAlias}", method=RequestMethod.GET)
    public void getMethodParameters(
    	  ...
    	  try {
    		  ...
    		  MetaMethod metaMethod = MetaK2TypeDef.Methods.getMetaMethod(methodAlias);
    ...
    @SuppressWarnings({ "rawtypes" })
    @RequestMapping(value="/entities/k2TypeDef/{id}/method/{methodAlias}", method=RequestMethod.POST)
