...
public class K2FieldServiceImpl extends GenericEntityService<K2FieldENT, Long, K2Field> implements K2FieldService{
	...
	public static class Lists {
		...
		public static class ForEntity extends K2FieldServiceList implements ServiceList<K2Field> {
			...
			@Override public K2Field newBO() { return service.newBO(new Init.ListForEntity(entity.getEntity())); }
	...
	public static class Init {
		...
		public static class ListForEntity extends EntityInitialValues<K2FieldENT> {
			...
			@Override public void initialize(K2FieldENT field) { field.setEntity(entity); }
		}
	...
	@Override
	public K2Field newBO(EntityInitialValues<K2FieldENT> init) {
		return (K2Field) serviceContext.putBO(new K2FieldBO(prepareNewEntity(new K2FieldENT(), "Field.ID", init), PersistenceState.NEW)); 
	}
	@Override
